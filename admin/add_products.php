...
<div class="container" style="margin:4rem 0">
	<div class="row">
		<div class="col-sm-6 col-sm-offset-3">
          ...
          <img src="../<?php echo $data['images'];?>" width="100px;" id = "walmart">
          <input type="file"  name="images" onchange = Walmart(this);>
        ...
        <div class="form-group">
                    <label for="exampleInputPassword1">Most Popular / Top Rated / Best Offer Image Uploaded
                        For</label><br />
                    <img src="../<?php echo $data['img_popular'];?>" width="100px;" id="usaimgpopularpop">
                    <input type="file" name="img_popular" onchange = Walmartpopimg(this);>
        </div>
